  ...
  return (
    <div className="container">
      <div className="col-sm-10 offset-sm-1" style={{ textAlign: 'left' }}>
        ...
        <p>Effective date: October 29th, 2019</p>
        <p>
          Buzzword Labs Inc. ("us", "we", or "our") operates the
          https://callpepper.co website (the "Service").
        </p>
        <p>
        ...
        <p>
          ...
          https://callpepper.co/#/terms-of-service
        </p>
        ...
        <h2>Use of Data</h2>
        <p>Buzzword Labs Inc. uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Buzzword Labs Inc. will take all steps reasonably necessary to ensure
        ...
        <p>
          Buzzword Labs Inc. may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Buzzword Labs Inc.
          </li>
          <li>
        ...
        <p>
          We use Twilio to run the call infrastructure of our service. For more
          information on the privacy practices of Twilio, please visit the
          Twilio Privacy web page:{' '}
        ...
        <ul>
          ...
          <li>
            ...
            <p>Hotjar is provided by Hotjar Ltd.</p>
            <p>
              We use <a href="https://www.hotjar.com/">Hotjar</a> in order to
              better understand our users’ needs and to optimize this service
              and experience. Hotjar is a technology service that helps us
              better understand our users experience (e.g. how much time they
              spend on which pages, which links they choose to click, what users
              do and don’t like, etc.) and this enables us to build and maintain
        ...
        <ul>
          <li>By email: pepper.digital.receptionist@gmail.com </li>
        </ul>
      </div>
    </div>
  );
